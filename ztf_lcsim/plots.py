...
_BAND_COLOUR = {1: "#2ecc71", 2: "#e74c3c", 3: "#3498db"}
...
def plot_results(
    ...
    spec = gridspec.GridSpec(n_rows, n_cols, figure=fig, hspace=0.55, wspace=0.35)
    ...
    for i, row in enumerate(results.itertuples(index=False)):
        ...
        ax.set_title(
            f"#{row.rank} {oid}{extra}\n{sim_str}", fontsize=7.5, pad=2
        )
...
def plot_feature_space(
    ...
    """2-D embedding of the feature space."""
    ...
    if labels is not None:
        ...
        for lbl in unique:
            ...
            ax.scatter(
                Zp[mask, 0], Zp[mask, 1],
                s=6, alpha=0.5, color=cmap[lbl], label=lbl, rasterized=True,
            )
...
def plot_feature_comparison(
    ...
    """Bar chart of the most discriminative features."""
